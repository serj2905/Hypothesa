...
Текущий вопрос — это поле `InterviewSession.current_index`, а не текст
сообщения. LLM отвечает только за две узкие задачи:
...
# свой список: start_interview(questions=[...]).
