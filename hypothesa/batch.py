...
from .llm import LLMClient, release_llm_client
...
def run_pending_summaries(
    ...
    *,
    ...
    try:
        ...
        release_llm_client(generator, "generator", close=owns_generator)
    ...
    try:
        ...
        release_llm_client(judge, "judge", close=owns_judge)
    return result
