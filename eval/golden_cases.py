...
Источник: DHA_hackathon/dialogs/*/user_result_user_respone.joblib (25 завершённых
диалогов, чистые ответы по вопросам 3/4 — без парсинга через langchain, это
обычные dict[str, str]) плюс перекрёстная сверка с DHA_hackathon/data/.../results.csv,
где видны реальные галлюцинации GigaChat. Это первые тест-кейсы eval-harness:
